...
import com.vedhafishfarm.VedhaNews.adapters.RelatedAdapter;
import com.vedhafishfarm.VedhaNews.api.ApiUtilities;
import com.vedhafishfarm.VedhaNews.api.HttpParams;
import com.vedhafishfarm.VedhaNews.data.constant.AppConstant;
import com.vedhafishfarm.VedhaNews.data.sqlite.BookmarkDbController;
import com.vedhafishfarm.VedhaNews.listeners.ListItemClickListener;
import com.vedhafishfarm.VedhaNews.listeners.WebListener;
import com.vedhafishfarm.VedhaNews.models.bookmark.BookmarkModel;
import com.vedhafishfarm.VedhaNews.models.comment.Comments;
import com.vedhafishfarm.VedhaNews.models.post.Post;
import com.vedhafishfarm.VedhaNews.models.post.PostDetails;
...
import com.vedhafishfarm.VedhaNews.utility.TtsEngine;
import com.vedhafishfarm.VedhaNews.webengine.PostWebEngine;
...
public class PostDetailsActivity extends BaseActivity {
    ...
    private TextView mTvTitle, mTvDate, mAuthorName, mTvComment, mTvRelated;
    private int mPostId;
        ...
        ApiUtilities.getApiInterface().getPostDetails(mPostId).enqueue(new Callback<PostDetails>() {
            ...
            public void onResponse(Call<PostDetails> call, Response<PostDetails> response) {
                if (response.isSuccessful()) {
                    ...
                    /*mAuthorName.setClickable(true);
                    mAuthorName.setMovementMethod(LinkMovementMethod.getInstance());
                    String authorName = mModel.getEmbedded().getAuthors().get(0).getName();
                    String authorLink = mModel.getEmbedded().getAuthors().get(0).getLink();
                    String text = "<a href='" + authorLink + "'>" + authorName + "</a>";
                    if (Build.VERSION.SDK_INT >= 24) {
                        mAuthorName.setText(Html.fromHtml(text, Html.FROM_HTML_MODE_LEGACY));
                    } else {
                        mAuthorName.setText(Html.fromHtml(text));
                    }*/
